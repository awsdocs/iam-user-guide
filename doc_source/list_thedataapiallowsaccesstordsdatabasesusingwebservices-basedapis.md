# Actions, Resources, and Condition Keys for The Data API allows access to RDS databases using web services\-based APIs<a name="list_thedataapiallowsaccesstordsdatabasesusingwebservices-basedapis"></a>
