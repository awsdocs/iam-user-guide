...
| --- | --- | --- | --- | --- | --- | 
| [AddTags](http://docs.aws.amazon.com/cloudsearch/latest/developerguide/API_AddTags.html) | Attaches resource tags to an Amazon CloudSearch domain\. | Tagging Write  | [domain\*](#amazoncloudsearch-domain)  |  |  | 
...
| [DescribeAnalysisSchemes](http://docs.aws.amazon.com/cloudsearch/latest/developerguide/API_DescribeAnalysisSchemes.html) | Gets the analysis schemes configured for a domain\. | Read Write  | [domain\*](#amazoncloudsearch-domain)  |  |  | 
| [DescribeAvailabilityOptions](http://docs.aws.amazon.com/cloudsearch/latest/developerguide/API_DescribeAvailabilityOptions.html) | Gets the availability options configured for a domain\. | Read Write  | [domain\*](#amazoncloudsearch-domain)  |  |  | 
| [DescribeDomains](http://docs.aws.amazon.com/cloudsearch/latest/developerguide/API_DescribeDomains.html) | Gets information about the search domains owned by this account\. | List Read Write  | [domain\*](#amazoncloudsearch-domain)  |  |  | 
| [DescribeExpressions](http://docs.aws.amazon.com/cloudsearch/latest/developerguide/API_DescribeExpressions.html) | Gets the expressions configured for the search domain\. | Read Write  | [domain\*](#amazoncloudsearch-domain)  |  |  | 
| [DescribeIndexFields](http://docs.aws.amazon.com/cloudsearch/latest/developerguide/API_DescribeIndexFields.html) | Gets information about the index fields configured for the search domain\. | Read Write  | [domain\*](#amazoncloudsearch-domain)  |  |  | 
| [DescribeScalingParameters](http://docs.aws.amazon.com/cloudsearch/latest/developerguide/API_DescribeScalingParameters.html) | Gets the scaling parameters configured for a domain\. | Read Write  | [domain\*](#amazoncloudsearch-domain)  |  |  | 
| [DescribeServiceAccessPolicies](http://docs.aws.amazon.com/cloudsearch/latest/developerguide/API_DescribeServiceAccessPolicies.html) | Gets information about the access policies that control access to the domain's document and search endpoints\. | Read Write  | [domain\*](#amazoncloudsearch-domain)  |  |  | 
| [DescribeSuggesters](http://docs.aws.amazon.com/cloudsearch/latest/developerguide/API_DescribeSuggesters.html) | Gets the suggesters configured for a domain\. | Read Write  | [domain\*](#amazoncloudsearch-domain)  |  |  | 
...
| [ListDomainNames](http://docs.aws.amazon.com/cloudsearch/latest/developerguide/API_ListDomainNames.html) | Lists all search domains owned by an account\. | List Read Write  | [domain\*](#amazoncloudsearch-domain)  |  |  | 
| [ListTags](http://docs.aws.amazon.com/cloudsearch/latest/developerguide/API_ListTags.html) | Displays all of the resource tags for an Amazon CloudSearch domain\. | Read Write  | [domain\*](#amazoncloudsearch-domain)  |  |  | 
| [RemoveTags](http://docs.aws.amazon.com/cloudsearch/latest/developerguide/API_RemoveTags.html) | Removes the specified resource tags from an Amazon ES domain\. | Tagging Write  | [domain\*](#amazoncloudsearch-domain)  |  |  | 
...
| search \[permission only\] | Allows access to the search operations\. | Read Write  |  |  |  | 
| suggest \[permission only\] | Allows access to the suggest operations\. | Read Write  |  |  |  | 
