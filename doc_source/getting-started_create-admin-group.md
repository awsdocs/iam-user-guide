...
**Important**  
If you arrived at this page trying to enable Amazon Advertising for your application or web site, see [Becoming a Product Advertising API Developer](http://alpha-docs-aws.amazon.com/AWSECommerceService/latest/DG/becomingDev.html)\.
...
1. Type the [http://alpha-docs-aws.amazon.com/cli/latest/reference/iam/create-group.html](http://alpha-docs-aws.amazon.com/cli/latest/reference/iam/create-group.html) command with the name you've chosen for the group\. Optionally, you can include a path as part of the group name\. For more information about paths, see [Friendly Names and Paths](reference_identifiers.md#identifiers-friendly-names)\. The name can consist of letters, digits, and the following characters: plus \(\+\), equal \(=\), comma \(,\), period \(\.\), at \(@\), underscore \(\_\), and hyphen \(\-\)\. The name is not case sensitive and can be a maximum of 128 characters in length\.
...
1. Type the [http://alpha-docs-aws.amazon.com/cli/latest/reference/iam/list-groups.html](http://alpha-docs-aws.amazon.com/cli/latest/reference/iam/list-groups.html) command to list the groups in your AWS account and confirm the group was created\.
...
1. Type the [http://alpha-docs-aws.amazon.com/cli/latest/reference/iam/attach-group-policy.html](http://alpha-docs-aws.amazon.com/cli/latest/reference/iam/attach-group-policy.html) command to attach the policy called AdministratorAccess to your Admins group\. The command uses the ARN of the AWS managed policy called AdministratorAccess\. 
...
1. Type the [http://alpha-docs-aws.amazon.com/cli/latest/reference/iam/list-attached-group-policies.html](http://alpha-docs-aws.amazon.com/cli/latest/reference/iam/list-attached-group-policies.html) command to confirm the policy is attached to the Admins group\.
...
You can confirm the contents of a particular policy with the [http://alpha-docs-aws.amazon.com/cli/latest/reference/iam/get-policy.html](http://alpha-docs-aws.amazon.com/cli/latest/reference/iam/get-policy.html) command\. 
...
+ [AWS Tasks that Require Account Root User](http://alpha-docs-aws.amazon.com/general/latest/gr/aws_tasks-that-require-root.html)
