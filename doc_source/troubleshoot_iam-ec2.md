...
### The `iam/info` Document Iindicates `"Code":"InstanceProfileNotFound"`<a name="w4aac24c18c17b2"></a>
...
### The `iam/info` Document Indicates a Success but Indicates `"Message":"Instance Profile does not contain a role..."`<a name="w4aac24c18c17b4"></a>
...
### The `iam/security-credentials/[role-name]` Document Indicates `"Code":"AssumeRoleUnauthorizedAccess"`<a name="w4aac24c18c17b6"></a>
