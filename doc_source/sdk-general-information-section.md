# Using IAM with an AWS SDK<a name="sdk-general-information-section"></a>
...
For examples specific to IAM, see [Code examples for IAM using AWS SDKs](service_code_examples.md)\.
