...
**Tip**  
This page is moving to a new location on November 16, 2020\. Please update your bookmark to use the new page at [https://docs\.aws\.amazon\.com/service\-authorization/latest/reference/list\_manageamazonapigateway\.html](https://docs.aws.amazon.com/service-authorization/latest/reference/list_manageamazonapigateway.html)\. 
...
+ [Resource types defined by Manage Amazon API Gateway](#manageamazonapigateway-resources-for-iam-policies)
...
## Resource types defined by Manage Amazon API Gateway<a name="manageamazonapigateway-resources-for-iam-policies"></a>
