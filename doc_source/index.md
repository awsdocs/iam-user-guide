...
+ [Access Management](access.md)
   + [Policies and Permissions](access_policies.md)
      ...
      + [Controlling Access Using IAM Tags](access_iam-tags.md)
      ...
      + [Example IAM Identity-Based Policies](access_policies_examples.md)
         ...
         + [AWS CodeCommit: Allows Read Access to an CodeCommit Repository, Programmatically and in the Console](reference_policies_examples_codecommit_pull.md)
