...
+ [Access management for AWS resources](access.md)
   + [Policies and permissions in IAM](access_policies.md)
      ...
      + [Example IAM identity-based policies](access_policies_examples.md)
         ...
         + [AWS: Deny access to resources outside your account except AWS managed IAM policies](resource_examples_iam_policies_resource_account.md)
         ...
         + [Amazon S3: Restrict management to a specific S3 bucket](reference_policies_examples_s3_deny-except-bucket.md)
...
+ [Code examples for IAM using AWS SDKs](service_code_examples.md)
   + [Code examples for IAM using AWS SDKs](service_code_examples_iam.md)
      + [Actions for IAM using AWS SDKs](service_code_examples_iam_actions.md)
         + [Add an IAM user to a group using an AWS SDK](example_iam_AddUserToGroup_section.md)
         + [Attach an IAM policy to a role using an AWS SDK](example_iam_AttachRolePolicy_section.md)
         + [Attach an IAM policy to a user using an AWS SDK](example_iam_AttachUserPolicy_section.md)
         + [Attach an inline policy to an IAM role using an AWS SDK](example_iam_PutRolePolicy_section.md)
         + [Create an IAM SAML provider using an AWS SDK](example_iam_CreateSAMLProvider_section.md)
         + [Create an IAM group using an AWS SDK](example_iam_CreateGroup_section.md)
         + [Create an IAM policy using an AWS SDK](example_iam_CreatePolicy_section.md)
         + [Create an IAM policy version using an AWS SDK](example_iam_CreatePolicyVersion_section.md)
         + [Create an IAM role using an AWS SDK](example_iam_CreateRole_section.md)
         + [Create an IAM service-linked role using an AWS SDK](example_iam_CreateServiceLinkedRole_section.md)
         + [Create an IAM user using an AWS SDK](example_iam_CreateUser_section.md)
         + [Create an IAM access key using an AWS SDK](example_iam_CreateAccessKey_section.md)
         + [Create an alias for an IAM account using an AWS SDK](example_iam_CreateAccountAlias_section.md)
         + [Create an inline IAM policy for a group using an AWS SDK](example_iam_PutGroupPolicy_section.md)
         + [Create an inline IAM policy for a user using an AWS SDK](example_iam_PutUserPolicy_section.md)
         + [Delete an IAM SAML provider using an AWS SDK](example_iam_DeleteSAMLProvider_section.md)
         + [Delete an IAM group using an AWS SDK](example_iam_DeleteGroup_section.md)
         + [Delete an IAM group policy using an AWS SDK](example_iam_DeleteGroupPolicy_section.md)
         ...
         + [Delete an IAM access key using an AWS SDK](example_iam_DeleteAccessKey_section.md)
         + [Delete an IAM account alias using an AWS SDK](example_iam_DeleteAccountAlias_section.md)
         + [Delete an inline IAM policy from a user using an AWS SDK](example_iam_DeleteUserPolicy_section.md)
         + [Detach an IAM policy from a role using an AWS SDK](example_iam_DetachRolePolicy_section.md)
         + [Detach an IAM policy from a user using an AWS SDK](example_iam_DetachUserPolicy_section.md)
         + [Generate a credential report from IAM using an AWS SDK](example_iam_GenerateCredentialReport_section.md)
         + [Get a credential report from IAM using an AWS SDK](example_iam_GetCredentialReport_section.md)
         + [Get a detailed IAM authorization report for your account using an AWS SDK](example_iam_GetAccountAuthorizationDetails_section.md)
         + [Get an IAM policy using an AWS SDK](example_iam_GetPolicy_section.md)
         + [Get an IAM policy version using an AWS SDK](example_iam_GetPolicyVersion_section.md)
         + [Get an IAM role using an AWS SDK](example_iam_GetRole_section.md)
         + [Get an IAM server certificate using an AWS SDK](example_iam_GetServerCertificate_section.md)
         + [Get an IAM service-linked role's deletion status using an AWS SDK](example_iam_GetServiceLinkedRoleDeletionStatus_section.md)
         + [Get a summary of account usage from IAM using an AWS SDK](example_iam_GetAccountSummary_section.md)
         + [Get an IAM user using an AWS SDK](example_iam_GetUser_section.md)
         + [Get data about the last use of an IAM access key using an AWS SDK](example_iam_GetAccessKeyLastUsed_section.md)
         + [Get the IAM account password policy using an AWS SDK](example_iam_GetAccountPasswordPolicy_section.md)
         + [List SAML providers for IAM using an AWS SDK](example_iam_ListSAMLProviders_section.md)
         + [List a user's IAM access keys using an AWS SDK](example_iam_ListAccessKeys_section.md)
         + [List IAM account aliases using an AWS SDK](example_iam_ListAccountAliases_section.md)
         + [List IAM groups using an AWS SDK](example_iam_ListGroups_section.md)
         + [List inline policies for an IAM role using an AWS SDK](example_iam_ListRolePolicies_section.md)
         + [List inline IAM policies for a user using an AWS SDK](example_iam_ListUserPolicies_section.md)
         + [List IAM policies using an AWS SDK](example_iam_ListPolicies_section.md)
         + [List policies attached to an IAM role using an AWS SDK](example_iam_ListAttachedRolePolicies_section.md)
         + [List IAM roles using an AWS SDK](example_iam_ListRoles_section.md)
         + [List IAM server certificates using an AWS SDK](example_iam_ListServerCertificates_section.md)
         + [List IAM users using an AWS SDK](example_iam_ListUsers_section.md)
         + [Remove an IAM user from a group using an AWS SDK](example_iam_RemoveUserFromGroup_section.md)
         + [Update an IAM server certificate using an AWS SDK](example_iam_UpdateServerCertificate_section.md)
         + [Update an IAM user using an AWS SDK](example_iam_UpdateUser_section.md)
         + [Update an IAM access key using an AWS SDK](example_iam_UpdateAccessKey_section.md)
         + [Upload an IAM server certificate using an AWS SDK](example_iam_UploadServerCertificate_section.md)
      + [Scenarios for IAM using AWS SDKs](service_code_examples_iam_scenarios.md)
         + [Create an IAM group and add a user to the group using an AWS SDK](example_iam_Scenario_GroupBasics_section.md)
         + [Create an IAM user and assume a role with AWS STS using an AWS SDK](example_iam_Scenario_CreateUserAssumeRole_section.md)
         + [Create read-only and read-write IAM users using an AWS SDK](example_iam_Scenario_UserPolicies_section.md)
         + [Manage IAM access keys using an AWS SDK](example_iam_Scenario_ManageAccessKeys_section.md)
         + [Manage IAM policies using an AWS SDK](example_iam_Scenario_PolicyManagement_section.md)
         + [Manage IAM roles using an AWS SDK](example_iam_Scenario_RoleManagement_section.md)
         + [Manage your IAM account using an AWS SDK](example_iam_Scenario_AccountManagement_section.md)
         + [Roll back an IAM policy version using an AWS SDK](example_iam_Scenario_RollbackPolicyVersion_section.md)
   + [Code examples for AWS STS using AWS SDKs](service_code_examples_sts.md)
      + [Actions for AWS STS using AWS SDKs](service_code_examples_sts_actions.md)
         + [Assume a role with AWS STS using an AWS SDK](example_sts_AssumeRole_section.md)
         + [Get a session token with AWS STS using an AWS SDK](example_sts_GetSessionToken_section.md)
      + [Scenarios for AWS STS using AWS SDKs](service_code_examples_sts_scenarios.md)
         + [Assume an IAM role that requires an MFA token with AWS STS using an AWS SDK](example_sts_Scenario_AssumeRoleMfa_section.md)
         + [Construct a URL with AWS STS for federated users using an AWS SDK](example_sts_Scenario_ConstructFederatedUrl_section.md)
         + [Get a session token that requires an MFA token with AWS STS using an AWS SDK](example_sts_Scenario_SessionTokenMfa_section.md)
...
+ [Using AWS Identity and Access Management Access Analyzer](what-is-access-analyzer.md)
   + [Findings for public and cross-account access](access-analyzer-findings.md)
