...
| [GetCDRBucket](http://docs.aws.amazon.com/chime/latest/ag/working-users.html#available-actions) | Gets the details of a Call Detail Record S3 bucket associated with your Amazon Chime account | Read |  |  |  | 
...
| [ListCDRBucket](http://docs.aws.amazon.com/chime/latest/ag/working-users.html#available-actions) | Lists Call Detail Record S3 buckets | List |  |  |  | 
...
| [ListGroups](http://docs.aws.amazon.com/chime/latest/ag/working-users.html#available-actions) | Lists Active Directory user groups associated with your Amazon Chime enterprise account | List |  |  |  | 
