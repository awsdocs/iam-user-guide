...
**Tip**  
This page is moving to a new location on November 16, 2020\. Please update your bookmark to use the new page at [https://docs\.aws\.amazon\.com/service\-authorization/latest/reference/list\_amazonchime\.html](https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazonchime.html)\. 
...
****  
[\[See the AWS documentation website for more details\]](http://docs.aws.amazon.com/IAM/latest/UserGuide/list_amazonchime.html)
...
| --- | --- | --- | 
|   meeting  |  arn:$\{Partition\}:chime::$\{AccountId\}:meeting/$\{MeetingId\}  |   [ aws:ResourceTag/$\{TagKey\} ](#amazonchime-aws_ResourceTag___TagKey_)   | 
