...
|   [ DescribeRegisteredRegions ](https://docs.aws.amazon.com/singlesignon/latest/userguide/iam-auth-access-using-id-policies.html#policyexample)  | Obtains the regions where your organization has enabled AWS Single Sign\-on | Read |  |  |  | 
