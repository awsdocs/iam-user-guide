...
This example shows how you might create an IAM policy that allows tag owners full access to RDS resources that they have tagged\. This policy grants the permissions necessary to complete this action programmatically from the AWS API or AWS CLI\.
