...
|   [ cluster\-endpoint ](https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_DBClusterEndpoint.html)  |  arn:$\{Partition\}:rds:$\{Region\}:$\{Account\}:cluster\-endpoint:$\{DbClusterEndpoint\}  |   [ aws:ResourceTag/$\{TagKey\} ](#amazonrds-aws_ResourceTag___TagKey_)   | 
