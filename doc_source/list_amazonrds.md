...
**Tip**  
This page is moving to a new location on November 16, 2020\. Please update your bookmark to use the new page at [https://docs\.aws\.amazon\.com/service\-authorization/latest/reference/list\_amazonrds\.html](https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazonrds.html)\. 
...
|   [ cluster\-endpoint ](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Aurora.Overview.Endpoints.html)  |  arn:$\{Partition\}:rds:$\{Region\}:$\{Account\}:cluster\-endpoint:$\{DbClusterEndpoint\}  |   [ aws:ResourceTag/$\{TagKey\} ](#amazonrds-aws_ResourceTag___TagKey_)   | 
...
|   [ global\-cluster ](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.Aurora.GlobalDB.html)  |  arn:$\{Partition\}:rds::$\{Account\}:global\-cluster:$\{GlobalCluster\}  |  | 
