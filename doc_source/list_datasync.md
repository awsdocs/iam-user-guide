...
+ View a [list of the API operations available for this service](https://docs.aws.amazon.com/datasync/latest/APIReference/)\.
+ Learn how to protect this service and its resources by [using IAM](https://docs.aws.amazon.com/datasync/latest/userguide/UsingIAMWith${Partition}DataSync.html) permission policies\.
