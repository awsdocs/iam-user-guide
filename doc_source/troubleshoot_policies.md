...
+ **Typo** – AWS checks that the JSON is syntactically correct, and that the policy does not include typos or other errors as part of [policy validation](access_policies_policy-validator.md)\.
