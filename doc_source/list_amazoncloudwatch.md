...
**Tip**  
This page is moving to a new location on November 16, 2020\. Please update your bookmark to use the new page at [https://docs\.aws\.amazon\.com/service\-authorization/latest/reference/list\_amazoncloudwatch\.html](https://docs.aws.amazon.com/service-authorization/latest/reference/list_amazoncloudwatch.html)\. 
...
+ [Resource types defined by Amazon CloudWatch](#amazoncloudwatch-resources-for-iam-policies)
...
## Resource types defined by Amazon CloudWatch<a name="amazoncloudwatch-resources-for-iam-policies"></a>
