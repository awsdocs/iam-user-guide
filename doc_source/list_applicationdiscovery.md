...
| [https://docs.aws.amazon.com/application-discovery/latest/APIReference/API_DescribeExportTasks.html](https://docs.aws.amazon.com/application-discovery/latest/APIReference/API_DescribeExportTasks.html) | Retrieve status of one or more export tasks\. You can retrieve the status of up to 100 export tasks\. | Read |  |  |  | 
