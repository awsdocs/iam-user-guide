...
![\[Single sign-on (SSO) to the AWS Management Console using SAML\]](http://alpha-docs-aws.amazon.com/IAM/latest/UserGuide/)![\[Single sign-on (SSO) to the AWS Management Console using SAML\]](http://alpha-docs-aws.amazon.com/IAM/latest/UserGuide/)![\[Single sign-on (SSO) to the AWS Management Console using SAML\]](http://alpha-docs-aws.amazon.com/IAM/latest/UserGuide/)
