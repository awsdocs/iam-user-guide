...
For more information, see [Getting Started with WorkSpaces](https://docs.aws.amazon.com/workspaces/latest/adminguide/getting_started.html) in the *Amazon WorkSpaces Administration Guide*\. 
